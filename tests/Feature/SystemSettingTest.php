...
class SystemSettingTest extends TestCase
{
    ...
    {
        SystemSetting::create(['key' => 'test_string', 'value' => 'Hello World']);
    ...
    {
        SystemSetting::create(['key' => 'test_bool_true', 'value' => 'true']);
        SystemSetting::create(['key' => 'test_bool_false', 'value' => 'false']);
    ...
    public function test_it_does_not_cast_numeric_booleans()
    {
        ...
        SystemSetting::create(['key' => 'test_num_one', 'value' => '1']);
        SystemSetting::create(['key' => 'test_num_zero', 'value' => '0']);
    ...
    public function test_it_automatically_decodes_json_strings_into_arrays()
    {
        ...
        SystemSetting::create(['key' => 'test_json_array', 'value' => $jsonArray]);
        SystemSetting::create(['key' => 'test_json_object', 'value' => $jsonObject]);
    ...
    {
        // 1. Create a setting
        $setting = SystemSetting::create(['key' => 'cache_test', 'value' => 'Initial Value']);
    ...
    {
        SystemSetting::create(['key' => 'empty_string', 'value' => '']);
        SystemSetting::create(['key' => 'null_value', 'value' => null]);
