...
use App\Livewire\Shop\Ai\AiChat;
...
class AiChatTest extends TestCase
{
    ...
    public function test_handles_local_file_uploads_correctly()
    {
        ...
        Storage::disk('local')->assertExists($mem->context_data['local_uploads'][0]['path']);
    }
    ...
    public function test_computes_global_files_from_chat_memory()
    {
        ...
        Livewire::actingAs($admin, 'admin')
            ...
            ->assertSet('globalFiles.0.name', 'test.jpg') // Descending order (newest first usually) -> wait, they were added in same action
            ->assertSet('globalFiles.1.name', 'User.php');
    }
}
