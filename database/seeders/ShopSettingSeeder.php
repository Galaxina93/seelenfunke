...
class ShopSettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $settings = [
            ...
            'inventory_low_stock_threshold' => '5',     // Warnung ab 5 Stück (angepasst an Config-Default)
            'skip_shipping_for_digital'     => 'false', // Versandberechnung auch bei digitalen Produkten (Standard aus)

            // Stripe Konfiguration
            'stripe_publishable_key'    => 'pk_test_51Sttm3GnukHKxpOefuWQRYa4eEgod0y7BKL42Muhu0EtNVvtPUb6dpGyOatPeos7J65z8jeFZFQ96U9yfXBDjBHC00yklMTHyX',
            'stripe_secret_key'         => '',
