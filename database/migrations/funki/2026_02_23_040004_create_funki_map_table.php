...
return new class extends Migration
{
    ...
    {
        Schema::create('funki_map_nodes', function (Blueprint $table) {
        ...
        Schema::create('funki_map_edges', function (Blueprint $table) {
            $table->uuid('id')->primary();
            ...
            $table->foreign('source_id')->references('id')->on('funki_map_nodes')->onDelete('cascade');
            $table->foreign('target_id')->references('id')->on('funki_map_nodes')->onDelete('cascade');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('funki_map_edges');
        Schema::dropIfExists('funki_map_nodes');
    }
};
