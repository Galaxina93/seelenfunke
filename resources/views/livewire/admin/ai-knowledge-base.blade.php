    ...
    <div class="animate-fade-in-up font-mono antialiased text-emerald-600 pb-12 w-full">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-black/90 backdrop-blur-md p-6 sm:p-10 rounded-2xl shadow-[0_0_30px_rgba(16,185,129,0.05)] border border-emerald-900/40 relative overflow-hidden mb-8">
            ...
            <div class="relative z-10">
                <h1 class="text-3xl sm:text-4xl font-black text-emerald-500 tracking-widest uppercase shadow-emerald-500/20 drop-shadow-md">Wissensdatenbank & KI-Core</h1>
                <p class="text-emerald-700 mt-2 text-sm font-bold uppercase tracking-widest">Das Gehirn von Mein Seelenfunke. Dokumentation, Fachbegriffe und Trainingsdaten.</p>
            </div>
                         ...
                         <div class="space-y-6">
                             ...
                             <div class="flex flex-col lg:flex-row gap-6 w-full">
                                 <div class="flex-1 w-full min-w-0">
                                     <livewire:global.ai.ai-knowledge-base-categories :selectedCategoryId="$editForm['ai_knowledge_base_category_id']" wire:key="kb-categories-{{ $editForm['id'] ?? 'new' }}" />
                                 ...
                                 <div class="flex-1 w-full min-w-0">
                                     <livewire:global.ai.ai-knowledge-base-tags :selectedTagIds="$editForm['tags']" wire:key="kb-tags-{{ $editForm['id'] ?? 'new' }}" />
                                 </div>
                             </div>
