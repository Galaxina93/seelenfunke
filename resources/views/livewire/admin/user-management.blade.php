        ...
        @if($isCreating || $editingId)
            ...
            <div class="bg-gray-900/80 backdrop-blur-md p-8 sm:p-10 rounded-[2.5rem] border border-gray-800 shadow-2xl relative overflow-hidden animate-fade-in mt-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center gap-3 text-primary mb-4 pb-2 border-b border-gray-800/50">
                        ...
                        @if($isCreating)
                            <div class="space-y-2">
                                ...
                                <select wire:model.live="createType" class="w-full text-sm border-gray-700 rounded-xl bg-gray-950 text-white shadow-inner p-4 outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all appearance-none cursor-pointer">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="space-y-2">
                                ...
                                <input type="text" wire:model="formData.first_name" class="w-full text-sm border-gray-700 rounded-xl bg-gray-950 text-white shadow-inner focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all p-4 outline-none">
                            </div>
                            <div class="space-y-2">
                                <label class="text-[9px] font-black text-gray-400 uppercase tracking-widest ml-1">Nachname *</label>
                                <input type="text" wire:model="formData.last_name" class="w-full text-sm border-gray-700 rounded-xl bg-gray-950 text-white shadow-inner focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all p-4 outline-none">
                            </div>
                        </div>

                        <div class="space-y-2">
                            <label class="text-[9px] font-black text-gray-400 uppercase tracking-widest ml-1">E-Mail Adresse *</label>
                            <input type="email" wire:model="formData.email" class="w-full text-sm border-gray-700 rounded-xl bg-gray-950 text-white shadow-inner focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all p-4 outline-none">
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div x-data="{ showPw: false }" class="relative">
                                <input :type="showPw ? 'text' : 'password'" wire:model="formData.password" placeholder="{{ $isCreating ? 'Mindestens 8 Zeichen' : 'Neues Passwort eingeben...' }}" class="w-full text-sm border-gray-700 rounded-xl bg-gray-950 text-white shadow-inner focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all p-4 pr-12 outline-none placeholder-gray-600">
                                <button type="button" @click="showPw = !showPw" class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 hover:text-primary transition-colors focus:outline-none">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-4 bg-gray-950 p-1.5 rounded-xl shadow-inner border border-gray-800">
                            <button wire:click="$set('formData.customer_type', 'private')" type="button" @class(['py-3.5 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all', 'bg-gray-800 text-primary shadow-[0_0_10px_rgba(0,0,0,0.5)] border border-gray-700' => $formData['customer_type'] === 'private', 'text-gray-500 hover:text-gray-300 hover:bg-gray-800/50' => $formData['customer_type'] !== 'private'])>
                                Privatperson
                            </button>
                            <button wire:click="$set('formData.customer_type', 'business')" type="button" @class(['py-3.5 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all', 'bg-gray-800 text-primary shadow-[0_0_10px_rgba(0,0,0,0.5)] border border-gray-700' => $formData['customer_type'] === 'business', 'text-gray-500 hover:text-gray-300 hover:bg-gray-800/50' => $formData['customer_type'] !== 'business'])>
                                Gewerblich (B2B)
                            </button>
                        </div>
                        ...
                        @if($formData['customer_type'] === 'business')
                            <div class="grid grid-cols-2 gap-4 animate-fade-in-up">
                                <div class="space-y-2">
                                    ...
                                    <input type="text" wire:model="formData.company_name" placeholder="GmbH, UG..." class="w-full text-sm border-gray-700 rounded-xl bg-gray-950 text-white shadow-inner focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all p-4 outline-none">
                                </div>
                                <div class="space-y-2">
                                    <label class="text-[9px] font-black text-gray-400 uppercase tracking-widest ml-1">USt-IdNr.</label>
                                    <input type="text" wire:model="formData.vat_id" placeholder="DE..." class="w-full text-sm border-gray-700 rounded-xl bg-gray-950 text-white shadow-inner focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all p-4 outline-none font-mono uppercase">
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="flex gap-4">
                            <div class="space-y-2 w-2/3">
                                ...
                                <input type="text" wire:model="formData.street" class="w-full text-sm border-gray-700 rounded-xl bg-gray-950 text-white shadow-inner focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all p-4 outline-none">
                            </div>
                            <div class="space-y-2 w-1/3">
                                <label class="text-[9px] font-black text-gray-400 uppercase tracking-widest ml-1">Nr.</label>
                                <input type="text" wire:model="formData.house_number" class="w-full text-sm border-gray-700 rounded-xl bg-gray-950 text-white shadow-inner focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all p-4 outline-none">
                            </div>
                        </div>
                        ...
                        <div class="flex gap-4">
                            <div class="space-y-2 w-1/3">
                                ...
                                <input type="text" wire:model="formData.postal" class="w-full text-sm border-gray-700 rounded-xl bg-gray-950 text-white shadow-inner focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all p-4 outline-none">
                            </div>
                            <div class="space-y-2 w-2/3">
                                <label class="text-[9px] font-black text-gray-400 uppercase tracking-widest ml-1">Stadt</label>
                                <input type="text" wire:model="formData.city" class="w-full text-sm border-gray-700 rounded-xl bg-gray-950 text-white shadow-inner focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all p-4 outline-none">
                            </div>
                        </div>

                        <div class="space-y-2">
                            <label class="text-[9px] font-black text-gray-400 uppercase tracking-widest ml-1">Telefon</label>
                            <input type="text" wire:model="formData.phone_number" class="w-full text-sm border-gray-700 rounded-xl bg-gray-950 text-white shadow-inner focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all p-4 outline-none">
                        </div>

                        <div class="space-y-2">
                            <label class="text-[9px] font-black text-gray-400 uppercase tracking-widest ml-1">Interne Notiz (Nur für Admins)</label>
                            <textarea wire:model="formData.internal_note" rows="3" placeholder="Besonderheiten, VIP Status..." class="w-full text-sm border-gray-700 rounded-xl bg-gray-950 text-white shadow-inner focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all p-4 outline-none resize-none"></textarea>
                        </div>
                    </div>
                </div>
                            ...
                            <tr class="transition-all duration-300 group hover:bg-gray-800/40 cursor-default">
                                <td class="px-6 sm:px-8 py-4 align-top">
                                    <div class="flex items-center gap-4">
                                        <div class="h-12 w-12 rounded-[1.2rem] shrink-0 bg-gray-950 border border-gray-800 flex items-center justify-center text-primary font-serif text-xl font-bold shadow-[inset_0_-2px_10px_rgba(0,0,0,0.5),_0_0_15px_rgba(197,160,89,0.1)] group-hover:shadow-[inset_0_-2px_10px_rgba(0,0,0,0.5),_0_0_20px_rgba(197,160,89,0.3)] transition-shadow">
                                ...
                                <td class="px-6 sm:px-8 py-4 align-top">
                                    ...
                                    @if(!empty($profile['internal_note']))
                                        <div class="inline-flex items-center gap-1.5 bg-primary/10 text-primary border border-primary/20 px-2 py-1 rounded text-[9px] font-black uppercase tracking-widest" title="{{ $profile['internal_note'] }}">
                                    ...
                                    <div class="flex justify-end gap-2 mt-1">
                                        @if(!$showArchive)
                                            <div class="opacity-100 xl:opacity-0 group-hover:opacity-100 transition-opacity flex gap-2">
                                                <button wire:click="startEdit('{{ $user['id'] }}', '{{ $user['user_type'] }}')" class="p-2.5 bg-gray-950 border border-gray-800 text-gray-500 hover:text-primary hover:border-primary/30 rounded-xl transition-all shadow-inner" title="Bearbeiten">
