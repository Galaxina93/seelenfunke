                        ...
                        @forelse($tasks as $task)
                            <div class="group/task" x-data="{ showMenu: false, isAddingSub: false, subTitle: '' }">
                                ...
                                <div @class([
                                    ...
                                    'shadow-lg hover:border-primary/40' => !$task->is_completed,
                                    ...
                                    <div class="flex-1 min-w-0 pt-0.5" x-data="{ isEditing: false, updatedTitle: '{{ $task->title }}' }">
                                        <div x-show="!isEditing"
                                            ...
                                            @class(['text-sm font-bold leading-relaxed break-words cursor-text hover:text-primary transition-colors pr-4', 'line-through text-gray-600 italic' => $task->is_completed, 'text-gray-200' => !$task->is_completed])>
                                            {!! preg_replace(
