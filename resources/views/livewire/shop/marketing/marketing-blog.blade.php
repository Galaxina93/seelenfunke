<div style="--theme-color: {{ $this->themeColorHex }}; --theme-color-10: {{ $this->themeColorHex }}1A; --theme-color-20: {{ $this->themeColorHex }}33; --theme-color-30: {{ $this->themeColorHex }}4D; --theme-color-40: {{ $this->themeColorHex }}66; --theme-color-50: {{ $this->themeColorHex }}80;" class="animate-fade-in-up font-sans antialiased text-gray-300 min-h-screen">
    <div class="pb-20">
                    ...
                    <div class="p-6 sm:p-8 border-b border-gray-800 flex gap-4 bg-gray-950/50 shadow-inner">
                        <div class="relative flex-1 group">
                            <input wire:model.live.debounce.300ms="search" type="text" placeholder="Beitrag suchen..."
                                   class="w-full pl-12 pr-4 py-3.5 bg-gray-900 border border-gray-800 rounded-xl text-sm text-white focus:bg-gray-950 focus:ring-2 focus:ring-[var(--theme-color-30)] focus:border-[var(--theme-color)] shadow-inner outline-none transition-all placeholder-gray-600">
                            <svg class="w-5 h-5 text-gray-500 absolute left-4 top-1/2 -translate-y-1/2 group-focus-within:text-[var(--theme-color)] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <td class="px-6 sm:px-8 py-6 align-top text-right">
                                        <div class="flex items-center justify-end gap-2">
                                            <button wire:click="edit('{{ $post->id }}')"
                                                    class="p-2.5 bg-gray-950 border border-gray-800 text-gray-500 hover:bg-[var(--theme-color-10)] hover:border-[var(--theme-color-30)] hover:text-[var(--theme-color)] rounded-xl transition-all shadow-inner" title="Bearbeiten">
                ...
                <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
                    ...
                    <div class="xl:col-span-2 space-y-8">
                        ...
                        <div class="bg-gray-900/80 backdrop-blur-xl p-6 sm:p-10 rounded-[2.5rem] border border-gray-800 shadow-2xl">
                            ...
                            @php
                                $inputClass = "w-full border border-gray-800 bg-gray-950 text-white rounded-xl px-4 py-3.5 text-sm focus:ring-2 focus:ring-[var(--theme-color-30)] focus:border-[var(--theme-color)] focus:bg-black transition-all shadow-inner outline-none placeholder-gray-600";
                                $labelClass = "block text-[9px] font-black uppercase tracking-widest text-gray-500 mb-2 ml-1";
                            @endphp

                            <div class="mb-8">
                                <label class="{{ $labelClass }}">Titel des Beitrags <span class="text-[var(--theme-color)] drop-shadow-[0_0_5px_currentColor]">*</span></label>
                            ...
                            <div class="mb-8">
                                <label class="{{ $labelClass }}">Permalink (Slug) <span class="text-[var(--theme-color)] drop-shadow-[0_0_5px_currentColor]">*</span></label>
                            ...
                            <div class="mb-8" wire:ignore>
                                <label class="{{ $labelClass }}">Inhalt <span class="text-[var(--theme-color)] drop-shadow-[0_0_5px_currentColor]">*</span></label>
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="bg-gray-900/80 backdrop-blur-xl p-6 sm:p-8 rounded-[2.5rem] border border-gray-800 shadow-2xl">
                            ...
                            <div class="mb-6">
                                <div class="flex justify-between items-center mb-2 ml-1">
                                    ...
                                    <button wire:click="openCategoryManager" class="text-[9px] font-black uppercase tracking-widest text-[var(--theme-color)] border-b border-[var(--theme-color-30)] hover:text-white hover:border-white transition-colors pb-0.5">
                                        Verwalten
                                    </button>
                                </div>
                                <div class="relative group">
                        ...
                        <div class="bg-gray-900/80 backdrop-blur-xl p-6 sm:p-8 rounded-[2.5rem] border border-gray-800 shadow-2xl space-y-8">
                            ...
                            <label class="block w-full">
                                ...
                                <input type="file" wire:model="image" class="block w-full text-[10px] font-black uppercase tracking-widest text-gray-500 file:mr-4 file:py-2.5 file:px-5 file:rounded-xl file:border-0 file:bg-gray-950 file:border-gray-800 file:text-[var(--theme-color)] hover:file:bg-gray-900 hover:file:text-white cursor-pointer transition-all file:shadow-inner"/>
                            </label>
                            ...
                            <div class="pt-6 border-t border-gray-800">
                                ...
                                <label class="block w-full">
                                    ...
                                    <input type="file" wire:model="headerImage" class="block w-full text-[10px] font-black uppercase tracking-widest text-gray-500 file:mr-4 file:py-2.5 file:px-5 file:rounded-xl file:border-0 file:bg-gray-950 file:border-gray-800 file:text-[var(--theme-color)] hover:file:bg-gray-900 hover:file:text-white cursor-pointer transition-all file:shadow-inner"/>
                                </label>
