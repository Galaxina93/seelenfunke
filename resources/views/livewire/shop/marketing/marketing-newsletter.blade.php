    ...
    <div class="pb-20">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex border-b border-gray-800 mb-8 overflow-x-auto no-scrollbar gap-6">
                <button wire:click="setTab('templates')" class="pb-4 px-2 border-b-2 text-[10px] sm:text-xs font-black uppercase tracking-widest transition-all whitespace-nowrap {{ $activeTab === 'templates' ? 'border-[var(--theme-color)] text-[var(--theme-color)] drop-shadow-[0_0_8px_currentColor]' : 'border-transparent text-gray-500 hover:text-gray-300' }}">Automationen</button>
                <button wire:click="setTab('subscribers')" class="pb-4 px-2 border-b-2 text-[10px] sm:text-xs font-black uppercase tracking-widest transition-all whitespace-nowrap {{ $activeTab === 'subscribers' ? 'border-[var(--theme-color)] text-[var(--theme-color)] drop-shadow-[0_0_8px_currentColor]' : 'border-transparent text-gray-500 hover:text-gray-300' }}">Abonnenten</button>
                <button wire:click="setTab('archive')" class="pb-4 px-2 border-b-2 text-[10px] sm:text-xs font-black uppercase tracking-widest transition-all whitespace-nowrap {{ $activeTab === 'archive' ? 'border-[var(--theme-color)] text-[var(--theme-color)] drop-shadow-[0_0_8px_currentColor]' : 'border-transparent text-gray-500 hover:text-gray-300' }}">Archiv</button>
            </div>
                    ...
                    @if($editingTemplateId)
                        ...
                        <div class="bg-gray-950/80 backdrop-blur-xl rounded-[3rem] border border-gray-800 overflow-hidden shadow-[0_30px_100px_rgba(0,0,0,0.6)] w-full">
                                ...
                                <div class="lg:col-span-4 space-y-6 lg:space-y-8 w-full">
                                    ...
                                    <div class="bg-gray-900/30 rounded-[2rem] p-6 border border-gray-800 border-dashed w-full">
                                        <h5 class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-4 flex items-center gap-2">
                                            <x-heroicon-o-paper-airplane class="w-4 h-4 text-[var(--theme-color)]" />
                                            Qualitätssicherung
                                        </h5>
                            ...
                            <div class="bg-gray-900/50 px-6 sm:px-8 py-5 sm:py-6 border-t border-gray-800 flex flex-col-reverse sm:flex-row justify-end gap-4 shadow-inner">
                                ...
                                <button wire:click="saveTemplate" class="w-full sm:w-auto px-10 py-4 rounded-xl bg-[var(--theme-color)] text-gray-900 font-black text-[10px] uppercase tracking-[0.2em] hover:bg-white hover:scale-[1.05] transition-all shadow-[0_0_30px_rgba(197,160,89,0.3)] text-center flex items-center justify-center gap-2">
                            ...
                            <div class="fixed inset-0 bg-gray-950/80 backdrop-blur-md z-[100] flex items-center justify-center p-4 sm:p-6" x-data @keydown.escape.window="$wire.showCreateModal = false">
                                <div class="bg-gray-900 border border-gray-800 rounded-[2rem] shadow-2xl w-full max-w-md overflow-hidden animate-fade-in-up">
                                        ...
                                        <div class="space-y-4">
                                            @if($new_type === 'automated')
                                                ...
                                                <div>
                                                    ...
                                                    <select wire:model="new_target_event_key" class="w-full bg-gray-950 border border-gray-800 text-white font-bold text-sm rounded-xl px-4 py-3.5 focus:ring-2 focus:ring-[var(--theme-color-30)] focus:border-[var(--theme-color)] outline-none transition-all shadow-inner appearance-none cursor-pointer">
                                    ...
                                    <div class="px-6 py-5 border-t border-gray-800 bg-gray-950/50 flex justify-end gap-4">
                                        ...
                                        <button wire:click="createTemplate" class="px-6 py-2.5 rounded-xl bg-[var(--theme-color)] text-gray-900 font-black text-[10px] uppercase tracking-widest hover:bg-white hover:scale-105 transition-all shadow-[0_0_15px_rgba(197,160,89,0.3)] flex items-center gap-2">
                    ...
                    <div class="bg-gray-900/80 backdrop-blur-xl rounded-[2.5rem] shadow-2xl border border-gray-800 overflow-hidden">
                        <div class="p-6 sm:p-8 border-b border-gray-800 bg-gray-950/50 shadow-inner flex flex-col sm:flex-row gap-6 items-center justify-between">
                            <div class="relative flex-1 group w-full sm:max-w-md">
                                <input wire:model.live.debounce.300ms="search" type="text" placeholder="Abonnent suchen..." class="w-full pl-12 pr-4 py-3.5 bg-gray-900 border border-gray-800 rounded-xl text-sm text-white focus:bg-gray-950 focus:ring-2 focus:ring-[var(--theme-color-30)] focus:border-[var(--theme-color)] shadow-inner outline-none transition-all placeholder-gray-600">
