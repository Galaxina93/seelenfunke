                    ...
                    return {
                        ...
                        initCharts() {
                            ...
                            newsletterChartObj = new Chart(ctxNl, {
                                type: 'line',
                                data: {
                                    labels: data.newsletter.labels,
                                    datasets: [{
                                        label: 'Neue Abonnenten',
                                        data: data.newsletter.data,
                            ...
                            voucherChartObj = new Chart(ctxVc, {
                                type: 'bar',
                                data: {
                                    labels: data.voucher.labels,
                                    datasets: [{
                                        label: 'Erstellte Gutscheine',
                                        data: data.voucher.data,
                            ...
                            voucherTypeChartObj = new Chart(ctxVt, {
                                type: 'doughnut',
                                data: {
                                    labels: data.voucherType.labels,
                                    datasets: [{
                                        data: data.voucherType.data,
