<section class="bg-gray-900/80 backdrop-blur-xl rounded-[1.5rem] sm:rounded-[2.5rem] shadow-2xl border border-gray-800 relative overflow-hidden transition-all duration-500 flex flex-col h-full w-full min-h-[calc(100vh-140px)]"
    ...
    {{-- HEADER --}}
    @include('livewire.shop.system.system-map-partials.header')

    {{-- CANVAS --}}
    @include('livewire.shop.system.system-map-partials.canvas')

    {{-- ===================== MODAL: NEUER KNOTEN ===================== --}}
    @include('livewire.shop.system.system-map-partials.modal-new-knot')

    {{-- ===================== MODAL: KNOTEN BEARBEITEN ===================== --}}
    @include('livewire.shop.system.system-map-partials.modal-knot')
