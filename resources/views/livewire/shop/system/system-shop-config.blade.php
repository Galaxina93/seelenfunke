<div class="p-4 lg:p-8 bg-transparent min-h-screen font-sans antialiased text-gray-300" style="--theme-color: {{ $this->themeColorHex }};" x-data="{ activeTab: localStorage.getItem('shop_config_tab') || 'general' }" x-init="$watch('activeTab', value => localStorage.setItem('shop_config_tab', value))">
    <div class="max-w-6xl mx-auto animate-fade-in-up">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
            ...
            <button
                ...
                :class="saved ? 'bg-emerald-500 text-gray-900 shadow-[0_0_20px_rgba(16,185,129,0.4)]' : 'bg-[var(--theme-color)] text-gray-900 hover:bg-[var(--theme-color)]-dark hover:scale-[1.02] shadow-[0_0_15px_var(--theme-color)0.2)]'"
        ...
        @php
            $inputClass = "w-full bg-gray-950 border border-gray-800 text-white rounded-xl text-sm p-3.5 focus:bg-black focus:ring-2 focus:ring-[var(--theme-color)]/30 focus:border-[var(--theme-color)] transition-all shadow-inner outline-none placeholder-gray-600";
        ...
        <div class="grid grid-cols-1 gap-8">
            ...
            {{-- TAB: ALLGEMEIN --}}
            {{-- TAB: ALLGEMEIN --}}
            @include('livewire.shop.system.system-config-partials.general_tab')

            {{-- TAB: PRODUKT & MARKETING --}}
            @include('livewire.shop.system.system-config-partials.products_tab')

            {{-- TAB: VERSAND --}}
            @include('livewire.shop.system.system-config-partials.shipping_tab')
