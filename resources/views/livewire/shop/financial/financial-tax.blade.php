                ...
                <div class="lg:col-span-5 space-y-8">
                    ...
                    <div x-data="{ expandedAuth: false }" class="bg-gray-900/50 border border-gray-800 rounded-xl p-4 mt-4">
                        ...
                        <div x-show="expandedAuth" x-collapse class="mt-4 pt-4 border-t border-gray-800 space-y-4">
                            <select wire:model.live="authMethod" class="w-full bg-gray-950 border border-gray-800 text-white text-xs font-bold rounded-lg px-3 py-2 focus:ring-2 focus:ring-primary/30 outline-none shadow-inner cursor-pointer">
