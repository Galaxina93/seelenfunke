                    ...
                    <ul class="space-y-4 relative z-10">
                        @foreach($item->histories as $history)
                            <li class="flex items-start gap-4" x-data="{ expanded: false }">
                                <div class="w-6 h-6 rounded-full bg-gray-900 border-2 border-primary/50 flex items-center justify-center shrink-0 mt-0.5 shadow-[0_0_10px_rgba(197,160,89,0.2)]">
