    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative">
            ...
            <div wire:loading wire:target="handlePaymentSuccess"
                 class="fixed inset-0 lg:absolute z-[100] flex flex-col items-center justify-center bg-white/70 backdrop-blur-md rounded-2xl transition-all">
                <div class="flex flex-col items-center bg-white p-8 rounded-3xl shadow-2xl border border-gray-100">
                    ...
                    <p class="text-gray-500 text-sm mt-2">Wir bereiten deine Rechnung vor und senden dir die Bestätigung...</p>
                </div>
            </div>
