<div style="--theme-color: {{ $this->themeColorHex }}; --theme-color-5: {{ $this->themeColorHex }}0D; --theme-color-10: {{ $this->themeColorHex }}1A; --theme-color-15: {{ $this->themeColorHex }}26; --theme-color-20: {{ $this->themeColorHex }}33; --theme-color-30: {{ $this->themeColorHex }}4D; --theme-color-40: {{ $this->themeColorHex }}66; --theme-color-50: {{ $this->themeColorHex }}80; --theme-color-70: {{ $this->themeColorHex }}B3;">
    ...
    <div class="bg-transparent pb-20 font-sans text-gray-300">
        ...
        <div>
            <div class="max-w-7xl mx-auto px-4 py-8 md:py-12 space-y-8 md:space-y-12 animate-fade-in-up" style="animation-delay: 100ms;">
                ...
                @include('livewire.shop.accounting.partials.category_management')

                {{-- 2. LISTE DER SONDERAUSGABEN (Tabelle & Chart) --}}
                @include('livewire.shop.accounting.partials.special_issue_list')
            </div>
        </div>
    </div>
            ...
            <div class="bg-gray-900/90 backdrop-blur-xl border border-gray-800 rounded-[2.5rem] shadow-[0_0_50px_rgba(0,0,0,0.5)] max-w-md w-full overflow-hidden">
                <div class="p-8">
                    ...
                    <div class="mb-8">
                        ...
                        <select wire:model="targetCategoryId" class="w-full bg-gray-950 border border-gray-800 text-white rounded-xl text-sm p-3.5 focus:bg-black focus:ring-2 focus:ring-[var(--theme-color-30)] focus:border-[var(--theme-color)] transition-all shadow-inner outline-none cursor-pointer">
    ...
    {{-- Chart Script --}}
    @include('livewire.shop.accounting.accounting-variable-costs.partials.chart_scripts')
</div>
