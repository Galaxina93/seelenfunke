                    ...
                    <div x-show="showLogin" x-cloak class="max-w-sm mx-auto text-left animate-fade-in-up bg-white p-8 rounded-2xl border border-gray-200 shadow-xl mt-4 relative">
                        ...
                        <div class="space-y-5">
                            <label class="block w-full">
                                ...
                                <input type="email" wire:model="loginEmail" class="block w-full rounded-xl bg-gray-50 border-gray-200 shadow-sm focus:bg-white focus:border-amber-500 focus:ring-amber-500 sm:text-sm py-3 px-4 transition-colors">
                            ...
                            <label class="block w-full" x-data="{ showPw: false }">
                                ...
                                <div class="relative">
                                    <input :type="showPw ? 'text' : 'password'" wire:model="loginPassword" wire:keydown.enter="loginUser" class="block w-full rounded-xl bg-gray-50 border-gray-200 shadow-sm focus:bg-white focus:border-amber-500 focus:ring-amber-500 sm:text-sm py-3 px-4 transition-colors pr-10">
                            ...
                            <div class="flex flex-col gap-3 pt-6 mt-4 border-t border-gray-100">
                                <button type="button" wire:click="loginUser" wire:loading.attr="disabled" class="w-full flex justify-center py-3.5 px-4 rounded-xl shadow-md text-sm font-bold text-white bg-amber-600 hover:bg-amber-700 transition-all uppercase tracking-widest transform hover:-translate-y-0.5">
