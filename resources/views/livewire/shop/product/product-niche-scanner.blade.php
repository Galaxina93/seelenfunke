            ...
            <div class="border-t border-gray-800 pt-8 mt-4 max-w-4xl mx-auto">
                ...
                <div class="flex justify-center">
                    <div class="flex items-center bg-gray-900/50 border border-purple-500/20 rounded-xl overflow-hidden pl-2 shadow-[0_0_15px_rgba(168,85,247,0.15)]">
                        ...
                        <select wire:model="selectedAgentId" class="bg-transparent text-sm py-2 pl-2 pr-6 focus:outline-none cursor-pointer text-gray-300 appearance-none min-w-[200px]">
                        ...
                        <button wire:click="startAiRecommendation" wire:loading.attr="disabled" class="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-500/10 to-transparent hover:from-purple-500/20 text-purple-400 font-medium transition-all disabled:opacity-50 border-l border-gray-800 focus:outline-none">
                            <span wire:loading.remove wire:target="startAiRecommendation">
                                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
                            </span>
                            <span wire:loading wire:target="startAiRecommendation" class="animate-spin w-5 h-5 rounded-full border-t-2 border-r-2 border-purple-500"></span>
                            <span class="text-sm tracking-wide">Analysieren</span>
                        </button>
                    </div>
                </div>
