            ...
            <div x-show="$wire.has_separate_shipping" x-collapse style="display: none;">
                <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2 bg-white p-6 rounded-2xl border border-primary/20 shadow-sm">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model.live="shipping_first_name" class="mt-1 block w-full rounded-lg bg-gray-50 border-gray-300 sm:text-sm py-3 focus:bg-white focus:ring-primary focus:border-primary transition-colors @error('shipping_first_name') border-red-300 @enderror">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model.live="shipping_last_name" class="mt-1 block w-full rounded-lg bg-gray-50 border-gray-300 sm:text-sm py-3 focus:bg-white focus:ring-primary focus:border-primary transition-colors @error('shipping_last_name') border-red-300 @enderror">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" wire:model.live="shipping_address" class="mt-1 block w-full rounded-lg bg-gray-50 border-gray-300 sm:text-sm py-3 focus:bg-white focus:ring-primary focus:border-primary transition-colors @error('shipping_address') border-red-300 @enderror">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model.live="shipping_postal_code" class="mt-1 block w-full rounded-lg bg-gray-50 border-gray-300 sm:text-sm py-3 focus:bg-white focus:ring-primary focus:border-primary transition-colors @error('shipping_postal_code') border-red-300 @enderror">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model.live="shipping_city" class="mt-1 block w-full rounded-lg bg-gray-50 border-gray-300 sm:text-sm py-3 focus:bg-white focus:ring-primary focus:border-primary transition-colors @error('shipping_city') border-red-300 @enderror">
