                ...
                <div class="lg:col-span-8 space-y-4">
                    @foreach($items as $item)
                        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden transition hover:shadow-md" wire:key="item-{{ $item->id }}">
                                ...
                                <div class="flex flex-col items-center gap-4">
                                    ...
                                    <div class="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                                        @if($editingItemId == $item->id)
                                            <button wire:click="closeModal" class="flex-1 sm:flex-none inline-flex justify-center items-center gap-2 px-4 py-2 bg-gray-900 border border-gray-900 rounded-lg text-sm font-bold text-white shadow-sm hover:bg-black transition">
                                                Abbrechen
                                            </button>
                                        @else
                            ...
                            {{-- Inline Konfigurator --}}
                            @if($editingItemId == $item->id)
                                <div class="bg-white p-2 sm:p-4 animate-fade-in-down border-t border-primary/10">
