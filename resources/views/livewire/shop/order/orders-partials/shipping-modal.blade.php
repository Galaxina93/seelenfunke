        ...
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden transform transition-all animate-fade-in-up border border-gray-100">
            ...
            <div class="p-6">
                <p class="text-sm text-gray-600 mb-6 leading-relaxed">
                    Du bist dabei, den Status dieser Bestellung auf <strong
                        class="text-primary">"Versendet"</strong> zu ändern.
                    <br><br>
                    Möchtest du dem Kunden automatisch die <span
                        class="underline decoration-primary/30 decoration-2 underline-offset-2">Versandbestätigung per E-Mail</span>
                    senden?
                </p>
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <button wire:click="confirmShipment(true)"
                        ...
                        <svg class="w-5 h-5 text-white/90 group-hover:animate-pulse" fill="none" viewBox="0 0 24 24"
                             stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="bg-gray-50 px-6 py-3 border-t border-gray-100 flex justify-center">
                <button wire:click="cancelShipment"
