            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-white/5 text-sm">
                    ...
                    <tr class="hover:bg-white/5 transition-colors {{ $revocation->status === 'processed' ? 'opacity-60' : '' }}">
                        ...
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center px-2.5 py-1 rounded-md text-xs font-mono font-medium bg-gray-800 text-[var(--theme-color)] border border-[var(--theme-color-20)]">
                                ...
                                <div class="mt-2 flex flex-wrap gap-2">
                                    @foreach($revocation->attachments as $attachment)
                                        ...
                                        <a href="{{ route('admin.widerruf.file', ['revocation' => $revocation->id, 'fileName' => $fileName]) }}" target="_blank" class="inline-flex items-center gap-1.5 px-2.5 py-1 bg-gray-800 hover:bg-gray-700 text-[11px] font-medium text-gray-300 rounded-md border border-gray-700 transition-colors" title="{{ $fileName }}">
                                            <svg class="w-3.5 h-3.5 text-[var(--theme-color)] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
