...
<div>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-10">
            ...
            <div x-data="kpiDashboard" class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 my-4">
                {{-- Group 1: Operationeller Status --}}
                <div class="kpi-group bg-gray-900 border border-gray-700/60 rounded-3xl p-7 shadow-2xl relative overflow-hidden ring-1 ring-white/5 opacity-0">
                ...
                <div class="kpi-group bg-gray-900 border border-gray-700/60 rounded-3xl p-7 shadow-2xl relative overflow-hidden ring-1 ring-white/5 opacity-0">
                    ...
                    <h3 class="text-[10px] font-black uppercase tracking-widest text-[var(--theme-color)] mb-6 flex items-center gap-2">
                        <x-heroicon-s-cpu-chip class="w-4 h-4" /> System-Performance
                    </h3>
                    
                    <div class="space-y-6">
                        <div>
                            <div class="text-[11px] font-medium text-gray-500 mb-1 uppercase tracking-wider">Unique KI-Session Nutzer</div>
                        ...
                        <div>
                            <div class="text-[11px] font-medium text-gray-500 mb-1 uppercase tracking-wider">Ø KI Response Time (LLM)</div>
                            <div class="text-3xl font-black text-white flex items-baseline gap-1.5">
                ...
                <div class="kpi-group bg-gray-900 border border-gray-700/60 rounded-3xl p-7 shadow-2xl relative overflow-hidden ring-1 ring-white/5 opacity-0">
                    ...
                    <div class="grid grid-cols-2 gap-3 h-full pb-4">
                        ...
                        <div class="bg-gray-800/60 rounded-2xl p-4 border border-gray-700/50 flex flex-col justify-center items-center text-center">
                            ...
                            <div class="text-[9px] text-gray-500 font-medium">Ø Zeichen/Message</div>
                        </div>
                        <div class="bg-[var(--theme-color-5)] rounded-2xl p-4 border border-[var(--theme-color)]/20 flex flex-col justify-center items-center text-center group hover:bg-[var(--theme-color-10)] transition-colors">
                            <div class="text-[10px] text-[var(--theme-color)] uppercase tracking-widest font-bold mb-1">Drop-Off Rate</div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                <div class="bg-gray-800/80 rounded-2xl shadow-lg border border-gray-700/50 overflow-hidden backdrop-blur-sm">
