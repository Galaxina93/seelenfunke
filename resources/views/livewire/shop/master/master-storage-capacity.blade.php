<div x-data="{ expanded: false }" class="bg-black/40 border border-gray-800/60 rounded-3xl p-6 sm:p-8 backdrop-blur-md relative shadow-[0_0_20px_rgba(0,0,0,0.3)] mb-8">
    ...
    <script>
        const registerStorageCapacitySlider = () => {
            if (!Alpine.data('storageCapacitySlider')) {
        ...
        if (window.Alpine) {
            registerStorageCapacitySlider();
        } else {
            document.addEventListener('alpine:init', registerStorageCapacitySlider);
        }
    </script>
</div>
