<div class="p-6 min-h-screen bg-gray-50 font-sans text-gray-900 space-y-12">

    {{-- GLOBALER HEADER --}}
    <x-shop.funki-header
        title='"Funki´s Kommandozentrale"'
        subtitle="Ich steuere alle automatischen Prozesse für {{ auth()->user()->first_name }}. Hier hast du den vollen Überblick."
        status="Online">
        <x-shop.funki-kpi label="Abonnenten" value="{{ $stats['subscribers'] }}" color="green" />
        <x-shop.funki-kpi label="Automationen" value="{{ $stats['active_newsletter'] + $stats['active_vouchers'] }}" color="blue" />
        <x-shop.funki-kpi label="Manuelle Codes" value="{{ $stats['manual_coupons'] }}" color="purple" />
    </x-shop.funki-header>
    ...
    <div class="max-w-7xl mx-auto space-y-12">
        ...
        <section class="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 p-10 relative overflow-hidden transition-all duration-500">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start mb-8 gap-4">
                ...
                {{-- Keine Tabs mehr hier, nur Timeline Ansicht --}}
            </div>
        ...
        {{-- ======================================================================== --}}
        {{-- GUTSCHEIN SEKTION (AUTO ODER MANUELL) --}}
        {{-- ======================================================================== --}}
                ...
                <div class="flex gap-4 overflow-x-auto pb-6 pt-2 custom-scrollbar snap-x">
                    @foreach($autoVouchers as $voucher)
                        @php
                            ...
                            $isActive = $voucher->is_active && !$isPast;
                        ...
                        <div class="snap-start relative group">
                            <div wire:click="editVoucher('{{ $voucher->id }}')"
                                ...
                                <div class="w-56 p-5 rounded-2xl border transition-all duration-300 relative flex flex-col justify-between group min-h-[130px] {{ $isPast ? 'border-gray-200 bg-gray-50 opacity-60' : 'border-purple-200 bg-white' }}">
                            ...
                            <button
                                ...
                                class="absolute top-2 left-2 w-8 h-8 bg-white rounded-full text-gray-300 hover:text-purple-500 hover:bg-purple-50 shadow-md border border-gray-100 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 z-20"
                                title="Pausieren/Aktivieren">
