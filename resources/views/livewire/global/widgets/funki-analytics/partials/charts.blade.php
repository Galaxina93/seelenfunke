<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
    ...
    <div class="lg:col-span-2 bg-gray-900/80 backdrop-blur-md rounded-[2rem] p-6 shadow-2xl border border-gray-800 relative overflow-hidden">
        ...
        <div class="space-y-3 relative z-10">
            @if(isset($stats['product_ranking']) && count($stats['product_ranking']) > 0)
                ...
                @endforeach
            @else
                <div class="text-gray-500 italic text-sm text-center py-6">Keine Verkäufe im gewählten Zeitraum.</div>
            @endif
        </div>
    </div>
