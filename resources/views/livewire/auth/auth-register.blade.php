            ...
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
                <div class="flex flex-col justify-center h-full space-y-10 lg:sticky lg:top-24">
                    <div>
                        ...
                        <h2 class="text-4xl md:text-5xl font-serif font-bold text-white mb-6 leading-tight">Werde Teil<br><span class="text-transparent bg-clip-text bg-gradient-to-r from-primary-light to-primary">unserer Reise.</span></h2>
                        <p class="text-gray-400 text-lg leading-relaxed max-w-md">Erstelle dein Kundenkonto und entdecke exklusive Unikate, die wir mit viel Liebe in unserer Manufaktur fertigen.</p>
                        <p class="text-gray-400 text-sm mt-4">Bereits registriert? <a href="{{route('login')}}" class="text-primary hover:text-white transition-colors underline decoration-primary/50 underline-offset-4">Melde dich hier an.</a></p>
                    </div>
                    <div class="relative w-full flex justify-center lg:justify-start py-6 h-64 lg:h-80 xl:h-96">
                        ...
                        <img x-show="!termsAccepted" x-transition:enter="transition ease-out duration-500" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="transition ease-in duration-300" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95" src="{{asset('images/projekt/funki/funki_shy.webp')}}" alt="Funki freut sich auf dich" class="absolute z-10 h-full object-contain drop-shadow-2xl transform origin-center lg:origin-left">
                        <img x-show="termsAccepted" x-transition:enter="transition ease-out duration-500" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="transition ease-in duration-300" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95" src="{{asset('images/projekt/funki/funki_rose.webp')}}" alt="Funki freut sich auf dich" class="absolute z-10 h-full object-contain drop-shadow-2xl transform origin-center lg:origin-left" style="display: none;">
                    </div>
                </div>
                    ...
                    <form wire:submit.prevent="register" class="space-y-8" aria-label="Registrierungsformular">
                        <div class="space-y-4">
                            <h3 class="text-xs font-bold text-primary uppercase tracking-wider mb-4 flex items-center gap-2">
                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg> Persönliche Daten
                            </h3>
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-4">
                                <div class="space-y-2">
                                    <label class="text-xs font-bold text-gray-400 uppercase tracking-wider ml-1">Kundentyp *</label>
                                    <select wire:model.blur="is_business" required class="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white placeholder-gray-500 shadow-sm transition-all focus:border-primary focus:bg-white/10 focus:ring-1 focus:ring-primary focus:outline-none cursor-pointer">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                    ...
                                    <input wire:model.blur="firstname" id="firstname" type="text" required class="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white placeholder-gray-500 shadow-sm transition-all focus:border-primary focus:bg-white/10 focus:ring-1 focus:ring-primary focus:outline-none @error('firstname') border-red-500 @enderror">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input wire:model.blur="lastname" id="lastname" type="text" required class="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white placeholder-gray-500 shadow-sm transition-all focus:border-primary focus:bg-white/10 focus:ring-1 focus:ring-primary focus:outline-none @error('lastname') border-red-500 @enderror">
                            ...
                            <div class="space-y-2">
                                ...
                                <input wire:model.blur="email" id="email" type="email" autocomplete="email" required class="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white placeholder-gray-500 shadow-sm transition-all focus:border-primary focus:bg-white/10 focus:ring-1 focus:ring-primary focus:outline-none @error('email') border-red-500 @enderror">
                        ...
                        <div class="space-y-4">
                            <h3 class="text-xs font-bold text-primary uppercase tracking-wider mb-4 flex items-center gap-2">
                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg> Anschrift
                            </h3>
                            <div class="grid grid-cols-4 gap-4 mb-4">
                                <div class="col-span-3 space-y-2">
                                    <label for="street" class="text-xs font-bold text-gray-400 uppercase tracking-wider ml-1">Straße *</label>
                                    <input wire:model.blur="street" id="street" type="text" required class="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white placeholder-gray-500 shadow-sm transition-all focus:border-primary focus:bg-white/10 focus:ring-1 focus:ring-primary focus:outline-none @error('street') border-red-500 @enderror">
                                </div>
                                <div class="col-span-1 space-y-2">
                                    <label for="house_number" class="text-xs font-bold text-gray-400 uppercase tracking-wider ml-1">Nr. *</label>
                                    <input wire:model.blur="house_number" id="house_number" type="text" required class="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white placeholder-gray-500 shadow-sm transition-all focus:border-primary focus:bg-white/10 focus:ring-1 focus:ring-primary focus:outline-none @error('house_number') border-red-500 @enderror">
                                </div>
                            </div>
                            <div class="grid grid-cols-3 gap-4 mb-4">
                                <div class="col-span-1 space-y-2">
                                    <label for="postal" class="text-xs font-bold text-gray-400 uppercase tracking-wider ml-1">PLZ *</label>
                                    <input wire:model.blur="postal" id="postal" type="text" required class="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white placeholder-gray-500 shadow-sm transition-all focus:border-primary focus:bg-white/10 focus:ring-1 focus:ring-primary focus:outline-none @error('postal') border-red-500 @enderror">
                                </div>
                                <div class="col-span-2 space-y-2">
                                    <label for="city" class="text-xs font-bold text-gray-400 uppercase tracking-wider ml-1">Stadt *</label>
                                    <input wire:model.blur="city" id="city" type="text" required class="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white placeholder-gray-500 shadow-sm transition-all focus:border-primary focus:bg-white/10 focus:ring-1 focus:ring-primary focus:outline-none @error('city') border-red-500 @enderror">
                                </div>
                            </div>
                            <div class="space-y-2">
                                <label for="country" class="text-xs font-bold text-gray-400 uppercase tracking-wider ml-1">Land *</label>
                                <select wire:model.live="country" id="country" class="w-full rounded-xl border border-white/10 bg-[#1a1c23] px-4 py-3 text-white shadow-sm transition-all focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none cursor-pointer">
                        ...
                        <div class="space-y-4">
                            <h3 class="text-xs font-bold text-primary uppercase tracking-wider mb-4 flex items-center gap-2">
                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg> Sicherheit
                            </h3>
                            <div class="space-y-4">
                                <div class="space-y-2 relative">
                                    <label for="password" class="text-xs font-bold text-gray-400 uppercase tracking-wider ml-1">Passwort *</label>
                                    <input :type="show ? 'text' : 'password'" wire:model.live="password" id="password" autocomplete="new-password" required class="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 pr-10 text-white placeholder-gray-500 shadow-sm transition-all focus:border-primary focus:bg-white/10 focus:ring-1 focus:ring-primary focus:outline-none">
                                ...
                                <div class="space-y-2 relative">
                                    ...
                                    <input :type="show ? 'text' : 'password'" wire:model.live="password_confirmation" id="password_confirmation" required class="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 pr-10 text-white placeholder-gray-500 shadow-sm transition-all focus:border-primary focus:bg-white/10 focus:ring-1 focus:ring-primary focus:outline-none">
                                </div>
                        ...
                        <div class="pt-6 space-y-6">
                            ...
                            <button type="submit" @if(!$this->canRegister) disabled @endif wire:loading.attr="disabled" class="w-full flex justify-center items-center gap-3 py-4 px-6 rounded-xl text-sm font-bold uppercase tracking-widest transition-all duration-300 transform shadow-lg {{$this->canRegister ? 'bg-primary text-black hover:bg-white hover:-translate-y-1 hover:shadow-primary/50 cursor-pointer' : 'bg-gray-800 text-gray-500 cursor-not-allowed opacity-50'}}">
                                ...
                                <span wire:loading.remove>
                                    @if($this->canRegister) Kundenkonto erstellen @else Bitte alle Felder korrekt ausfüllen @endif
                                </span>
