...
@if($isMobile)
    @if($user)
        <div class="w-full flex flex-col space-y-1">
            <div class="flex items-center space-x-3 px-3 py-2 mb-2 bg-gray-800/50 rounded-lg">
                <div class="h-10 w-10 shrink-0 rounded-full overflow-hidden border-2 border-primary/50 bg-gray-100 flex items-center justify-center">
            ...
            <div class="overflow-hidden">
                <div class="text-base text-white font-medium truncate">{{ $user->first_name ?? '' }} {{ $user->last_name ?? '' }}</div>
    ...
    @else
        <div class="w-full">
            <a href="{{ route('login') }}" class="block w-full px-3 py-2 text-center text-white border border-gray-600 rounded-md hover:text-primary hover:border-primary transition-colors">Login / Kundenbereich</a>
        </div>
    @endif
@else
            ...
            @else
                ...
                <div class="px-4 py-3 text-center">
                    ...
                    <div class="text-xs text-gray-500">
                        Neu? <a href="{{ route('livewire.auth.register') }}" class="text-primary hover:underline font-bold">Registrieren</a>
                    </div>
                </div>
            @endif
