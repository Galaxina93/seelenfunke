            ...
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
                <div class="flex flex-col justify-center h-full space-y-10 lg:sticky lg:top-24">
                    ...
                    <div class="relative w-full flex justify-center lg:justify-start py-6 h-64 lg:h-80 xl:h-96">
                        ...
                        <img x-show="!termsAccepted" x-transition:enter="transition ease-out duration-500" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="transition ease-in duration-300" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95" src="{{asset('images/projekt/funki/funki_shy.png')}}" alt="Funki freut sich auf dich" class="absolute z-10 h-full object-contain drop-shadow-2xl transform origin-center lg:origin-left">
                        <img x-show="termsAccepted" x-transition:enter="transition ease-out duration-500" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="transition ease-in duration-300" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95" src="{{asset('images/projekt/funki/funki_rose.png')}}" alt="Funki freut sich auf dich" class="absolute z-10 h-full object-contain drop-shadow-2xl transform origin-center lg:origin-left" style="display: none;">
                    </div>
                </div>
