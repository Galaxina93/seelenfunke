<div>
                        ...
                        <ul role="list" class="divide-y divide-gray-800/50">
                            @foreach($selectedOrder->items as $item)
                                <li class="p-8 flex flex-col sm:flex-row gap-8 hover:bg-gray-800/20 transition-colors">
                                    {{-- Produktbild mit Priorität auf Main Bild --}}
                                    ...
                                    <div class="flex-1 flex flex-col justify-between">
                                        <div>
                                            <div class="flex justify-between items-start mb-2">
                                                ...
                                                <p class="text-xl font-serif font-bold text-primary ml-4">
                                ...
                                @if($previewItemId == $item->id && $this->previewItem)
                                    <div class="bg-gray-950 p-8 border-y border-gray-800 animate-fade-in-down shadow-inner">
                                        ...
                                        <div class="bg-gray-900 rounded-[2rem] border border-gray-800 overflow-hidden shadow-2xl w-full">
                                            <livewire:shop.product.product-configurator.product-configurator :product="$this->previewItem->product" :initialData="$this->previewItem->configuration" :qty="$this->previewItem->quantity" context="preview" :key="'conf-'.$this->previewItem->id" design="dark" />
                                        </div>
                                    </div>
                                @endif
                            @endforeach
    ...
    @else
        <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-12 gap-6 animate-fade-in-up">
            <div class="relative w-full sm:w-96 group">
                ...
                <input wire:model.live="searchOrder" type="text" placeholder="Bestellnummer suchen..." class="relative w-full rounded-full border border-gray-700 bg-gray-900 text-white shadow-inner focus:border-primary focus:ring-primary text-sm px-6 py-4 pl-14 transition-all placeholder-gray-500 font-medium tracking-wide">
