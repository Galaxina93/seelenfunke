    ...
    <x-sections.page-container>
            ...
            <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <article class="bg-white rounded-2xl shadow-xl overflow-hidden transition-transform hover:scale-105 duration-300 group ring-2 ring-primary ring-offset-4 relative z-10">
                    ...
                    <div class="p-6">
                        ...
                        <a href="{{ route('shop') }}" target="_blank" class="block text-center w-full bg-primary text-white py-2 rounded-md font-bold hover:bg-primary-dark transition-colors">
                            Zum Shop
                        </a>
                    </div>
                </article>
            ...
            <div id="fuer-herzensmenschen" class="relative bg-primary-dark overflow-hidden">
                ...
                <div class="relative max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-24">
                    <div class="md:w-1/2 md:pr-12">
                        ...
                        <div class="mt-8">
                            <a href="{{ route('shop') }}" target="_blank" class="text-primary font-bold hover:text-white transition-colors border-b-2 border-primary pb-1">
                                Zum Shop →
                            </a>
                        </div>
                    </div>
        ...
        <section id="faq" class="bg-gray-50 py-24 scroll-mt-20">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-16 fade-in">
                    <h2 class="text-3xl md:text-5xl font-serif font-bold text-gray-900 mb-6">
                        Antworten auf deine <span class="text-primary">Fragen</span>
                    </h2>
                    <p class="text-xl text-gray-600 leading-relaxed">
                        Du hast noch offene Punkte? Hier findest du die Antworten auf die häufigsten Fragen rund um unsere Manufaktur, den Versand und die Personalisierung.
                    </p>
                </div>
                ...
                <div class="space-y-4 fade-in">
                    ...
                    {{-- FRAGE 1: Material --}}
                    <details class="group bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden [&_summary::-webkit-details-marker]:hidden">
                        <summary class="flex cursor-pointer items-center justify-between gap-1.5 p-6 text-gray-900 transition-colors hover:bg-gray-50/50">
                            <h3 class="text-lg font-bold font-serif">Ist das wirklich Glas oder Acryl/Plastik?</h3>
                            <div class="white-space-no-wrap ml-4 flex-shrink-0">
                                <span class="relative flex h-8 w-8 items-center justify-center rounded-full border border-gray-200 bg-white transition-all group-open:rotate-45 group-open:border-primary group-open:text-primary">
                        ...
                        <div class="px-6 pb-6 text-gray-600 leading-relaxed">
                            <p>
                                Wir verwenden ausschließlich **massives K9-Kristallglas**. Das ist kein leichtes Plastik oder Acryl, sondern schweres, optisch reines Glas, das speziell für Laserinnengravuren entwickelt wurde. Du wirst den Qualitätsunterschied sofort am Gewicht und der Brillanz spüren, wenn du das Paket öffnest.
                            </p>
                        </div>
                    </details>

                    {{-- FRAGE 2: Eigenes Foto --}}
                    <details class="group bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden [&_summary::-webkit-details-marker]:hidden">
                        <summary class="flex cursor-pointer items-center justify-between gap-1.5 p-6 text-gray-900 transition-colors hover:bg-gray-50/50">
                            <h3 class="text-lg font-bold font-serif">Kann ich auch ein eigenes Foto gravieren lassen?</h3>
                            <div class="white-space-no-wrap ml-4 flex-shrink-0">
                                <span class="relative flex h-8 w-8 items-center justify-center rounded-full border border-gray-200 bg-white transition-all group-open:rotate-45 group-open:border-primary group-open:text-primary">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                        ...
                        <div class="px-6 pb-6 text-gray-600 leading-relaxed">
                            <p>
                                Ja, absolut! Das ist unsere Spezialität. Du kannst uns dein Wunschfoto einfach zusenden. Wichtig ist eine möglichst gute Auflösung und guter Kontrast. Bevor wir den Laser starten, prüft unser Team dein Bild manuell. Sollte die Qualität nicht ausreichen, melden wir uns proaktiv bei dir, um eine Lösung zu finden.
                            </p>
                        </div>
                    </details>
                    ...
                    <details class="group bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden [&_summary::-webkit-details-marker]:hidden">
                        <summary class="flex cursor-pointer items-center justify-between gap-1.5 p-6 text-gray-900 transition-colors hover:bg-gray-50/50">
                            <h3 class="text-lg font-bold font-serif">Wie lange dauert die Lieferung?</h3>
                            <div class="white-space-no-wrap ml-4 flex-shrink-0">
                                <span class="relative flex h-8 w-8 items-center justify-center rounded-full border border-gray-200 bg-white transition-all group-open:rotate-45 group-open:border-primary group-open:text-primary">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                        ...
                        <div class="px-6 pb-6 text-gray-600 leading-relaxed">
                            <p>
                                Da wir in unserer Manufaktur in Gifhorn produzieren, sind wir sehr schnell. In der Regel benötigen wir **1 bis 3 Werktage** für die Fertigung und Prüfung deines Unikats. Der Versand mit DHL dauert innerhalb Deutschlands meist noch einmal 1–2 Tage. Wenn es besonders eilig ist (z.B. ein vergessener Geburtstag), schreib uns bitte vorher kurz an!
                            </p>
                        </div>
                    </details>
                    ...
                    <details class="group bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden [&_summary::-webkit-details-marker]:hidden">
                        <summary class="flex cursor-pointer items-center justify-between gap-1.5 p-6 text-gray-900 transition-colors hover:bg-gray-50/50">
                            <h3 class="text-lg font-bold font-serif">Muss ich das Geschenk noch verpacken?</h3>
                            <div class="white-space-no-wrap ml-4 flex-shrink-0">
                                <span class="relative flex h-8 w-8 items-center justify-center rounded-full border border-gray-200 bg-white transition-all group-open:rotate-45 group-open:border-primary group-open:text-primary">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                        ...
                        <div class="px-6 pb-6 text-gray-600 leading-relaxed">
                            <p>
                                Nein, das übernehmen wir für dich. Jedes Glas-Unikat wird standardmäßig in einer sehr hochwertigen, **mit Stoff ausgelegten Geschenkbox** geliefert. Du kannst das Paket also direkt nach dem Auspacken aus dem Versandkarton feierlich überreichen.
                            </p>
                        </div>
                    </details>
                    ...
                    <details class="group bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden [&_summary::-webkit-details-marker]:hidden">
                        <summary class="flex cursor-pointer items-center justify-between gap-1.5 p-6 text-gray-900 transition-colors hover:bg-gray-50/50">
                            <h3 class="text-lg font-bold font-serif">Kann ich personalisierte Artikel zurückgeben?</h3>
                            <div class="white-space-no-wrap ml-4 flex-shrink-0">
                                <span class="relative flex h-8 w-8 items-center justify-center rounded-full border border-gray-200 bg-white transition-all group-open:rotate-45 group-open:border-primary group-open:text-primary">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                        ...
                        <div class="px-6 pb-6 text-gray-600 leading-relaxed">
                            <p>
                                Da wir das Produkt speziell für dich mit deinem Namen, Datum oder Foto anfertigen, ist eine klassische Rückgabe wegen "Nichtgefallen" leider rechtlich ausgeschlossen. <br><br>
                                <strong>Aber:</strong> Deine Zufriedenheit ist unser höchstes Gut. Sollte uns ein Fehler unterlaufen sein oder die Ware beschädigt ankommen, kümmern wir uns natürlich sofort um kostenlosen Ersatz. Schreib uns in diesem Fall bitte umgehend eine E-Mail.
                            </p>
                        </div>
                    </details>

                    {{-- FRAGE 6: Versandkosten --}}
                    <details class="group bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden [&_summary::-webkit-details-marker]:hidden">
                        <summary class="flex cursor-pointer items-center justify-between gap-1.5 p-6 text-gray-900 transition-colors hover:bg-gray-50/50">
                            <h3 class="text-lg font-bold font-serif">Was kostet der Versand?</h3>
                            <div class="white-space-no-wrap ml-4 flex-shrink-0">
                                <span class="relative flex h-8 w-8 items-center justify-center rounded-full border border-gray-200 bg-white transition-all group-open:rotate-45 group-open:border-primary group-open:text-primary">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                        ...
                        <div class="px-6 pb-6 text-gray-600 leading-relaxed">
                            <p>
                                Innerhalb Deutschlands versenden wir grundsätzlich **versandkostenfrei**. Der Preis, den du im Shop siehst, ist der Endpreis. Keine versteckten Gebühren im Warenkorb.
                            </p>
                        </div>
                    </details>

                    {{-- FRAGE 7: Großbestellungen --}}
                    <details class="group bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden [&_summary::-webkit-details-marker]:hidden">
                        <summary class="flex cursor-pointer items-center justify-between gap-1.5 p-6 text-gray-900 transition-colors hover:bg-gray-50/50">
                            <h3 class="text-lg font-bold font-serif">Gibt es Rabatte für Vereine oder Firmen?</h3>
                            <div class="white-space-no-wrap ml-4 flex-shrink-0">
                                <span class="relative flex h-8 w-8 items-center justify-center rounded-full border border-gray-200 bg-white transition-all group-open:rotate-45 group-open:border-primary group-open:text-primary">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                        ...
                        <div class="px-6 pb-6 text-gray-600 leading-relaxed">
                            <p>
                                Ja! Für Sportvereine (z.B. Pokale/Ehrungen) und Firmenkunden bieten wir attraktive Mengenrabatte an. Nutze dafür am besten unseren <a href="/calculator" class="text-primary font-bold hover:underline">Angebotskalkulator</a>. Für Vereine bieten wir nach Absprache auch den Kauf auf Rechnung an.
                            </p>
                        </div>
                    </details>
                    ...
                    <details class="group bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden [&_summary::-webkit-details-marker]:hidden">
                        <summary class="flex cursor-pointer items-center justify-between gap-1.5 p-6 text-gray-900 transition-colors hover:bg-gray-50/50">
                            <h3 class="text-lg font-bold font-serif">Wie reinige ich den Kristall am besten?</h3>
                            <div class="white-space-no-wrap ml-4 flex-shrink-0">
                                <span class="relative flex h-8 w-8 items-center justify-center rounded-full border border-gray-200 bg-white transition-all group-open:rotate-45 group-open:border-primary group-open:text-primary">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                        ...
                        <div class="px-6 pb-6 text-gray-600 leading-relaxed">
                            <p>
                                Damit dein Seelenfunke lange strahlt, empfehlen wir die Reinigung mit einem weichen Mikrofasertuch und etwas handelsüblichem Glasreiniger. Da die Gravur **im Inneren** des Glases liegt, kann sie nicht verstauben oder ausbleichen. Du musst also nur die Oberfläche abwischen.
                            </p>
                        </div>
                    </details>
                ...
                <div class="mt-12 text-center">
                    <p class="text-gray-500">
                        Deine Frage war nicht dabei? Schreib uns einfach eine Mail an
                        <a href="mailto:kontakt@mein-seelenfunke.de" class="text-primary font-bold hover:underline">kontakt@mein-seelenfunke.de</a>
                    </p>
                </div>
