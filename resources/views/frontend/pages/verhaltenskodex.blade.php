        ...
        <section class="max-w-4xl mx-auto px-4 py-20 text-gray-800">
            ...
            <div id="verhaltenskodex" class="scroll-mt-28">
                ...
                <div class="space-y-6 text-gray-700 leading-relaxed">
                    ...
                    <p>
                        Bei <strong>Mein-Seelenfunke</strong> legen wir großen Wert auf ein respektvolles und faires Miteinander.
                        Dieser Verhaltenskodex bildet die Grundlage für den Umgang zwischen Kund:innen, Geschäftspartner:innen
                        sowie unserem gesamten Team.
                    </p>
                    ...
                    <div>
                        ...
                        <p>
                            ...
                            wenn dies zur Abwicklung einer Bestellung erforderlich ist.
                        </p>
                    </div>
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded-lg p-4 mt-6">
                        ...
                        <p class="mt-2 text-sm text-gray-600">
                            Vielen Dank für dein Vertrauen – schön, dass du Teil der <strong>Mein-Seelenfunke-Community</strong> bist.
                        </p>
                        <p class="mt-2 text-sm">
                            📩 Kontakt: <a href="mailto:kontakt@mein-seelenfunke.de" class="text-primary hover:underline">kontakt@mein-seelenfunke.de</a>
                        </p>
                    </div>
