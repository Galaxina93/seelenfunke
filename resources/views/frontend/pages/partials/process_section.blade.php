            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-6">
                ...
                @php
                    $steps = [
                        [
                            'video' => 'beratung',
                            'image' => '/shop/frontend/process/beratung.webp',
                        ...
                        [
                            'video' => 'lasergravur',
                            'image' => '/shop/frontend/process/lasergravur.webp',
                        ...
                        [
                            'video' => '4_augen',
                            'image' => '/shop/frontend/process/handveredelung.webp',
                        ...
                        [
                            ...
                            'image' => '/shop/frontend/process/edle_verpackung.webp',
                        ...
                        [
                            ...
                            'image' => '/shop/frontend/process/sicherer_versand.webp',
                        ...
                        <div class="relative inline-block transition-transform transform group-hover:-translate-y-2 duration-300"
                             @if(isset($step['video']))
                                 ...
                                 playVideo() {
                                     ...
                                     if (!this.loaded) {
                                         this.$refs.video.src = '{{ asset('shop/frontend/process/' . $step['video'] . '.webm') }}';
                                         this.loaded = true;
                                     }
