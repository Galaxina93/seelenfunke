        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div class="flex flex-col items-start">
                ...
                <p class="text-sm text-gray-400 leading-relaxed">
                    Mit einer zertifizierten <strong>Laserschutzbeauftragten für Industrie & Gewerbe</strong> im Team stehen Sicherheit und Präzision für uns an erster Stelle. Unsere Maschinen werden regelmäßig gewartet und entsprechen höchsten Standards.
                </p>
            </div>
            ...
            <div>
                ...
                <ul class="text-gray-300 text-sm space-y-3">
                    <li>
                        <a href="https://www.etsy.com/de/shop/DEIN_SHOPNAME" target="_blank" class="hover:text-primary transition flex items-center gap-2">
                            <span>🛍️ Zum Etsy Shop</span>
                        </a>
                    </li>
                    <li><a href="mailto:kontakt@mein-seelenfunke.de" class="hover:text-primary transition">📧 kontakt@mein-seelenfunke.de</a></li>
                    <li class="h-px bg-gray-800 w-full my-2"></li> {{-- Trennlinie --}}
