...
<div class="container">
    ...
    <div class="content">
        ...
        <p>Hallo,</p>
        <p>Hier ist dein maßgeschneiderter Urlaubsplan. Das Dokument enthält alle wichtigen Stationen, Checklisten und Details für deine Reise.</p>
    ...
    <div class="footer">
        Dieser Reiseplan wurde automatisch generiert.<br>
        {{ date('d.m.Y H:i') }} Uhr
    </div>
</div>
</body>
