                ...
                <div class="flex flex-col md:flex-row justify-between items-center py-5 gap-4">
                    ...
                    <div class="flex items-center gap-5">
                        ...
                        <div>
                            ...
                            <p class="text-[10px] font-black uppercase tracking-[0.2em] text-gray-500 mt-1">Dein Autopilot für deinen Kalender</p>
                        </div>
                    </div>

                    <div class="hidden md:flex items-center gap-3">
                        <span class="px-4 py-2 bg-gray-950 border border-gray-800 text-primary rounded-xl text-[10px] font-black uppercase tracking-widest shadow-inner flex items-center gap-2">
                            <x-heroicon-s-calendar class="w-4 h-4" />
                            Planungssystem aktiv
                        </span>
                    </div>
                </div>
            </div>
