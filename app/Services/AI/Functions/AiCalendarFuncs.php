...
{
    public static function getAiCalendarFuncsSchema(): array
    {
        return [
            [
                'name' => 'calendar_get_events',
                'description' => 'Sucht Termine im lokalen Calender. WICHTIG: Das aktuelle Datum auf dem Server ist: ' . now()->format('Y-m-d H:i:s') . ' (' . now()->locale('de')->dayName . '). Wandle Aussagen wie "nächsten Dienstag" anhand dieses Datums selbstständig in echte Y-m-d Daten um. Stichworte: Was steht an, habe ich Termine, Kalender prüfen, was ist heute los, wann ist das Meeting.',
                'parameters' => [
                    'type' => 'object',
                    'properties' => [
                        'date_from' => [
            ...
            [
                ...
                'description' => 'Erstellt einen neuen Termin im lokalen Calender. Nutze dieses Tool, wenn der User sagt "Trag mir ein", "Erstelle einen Termin" etc. Stichworte: Termin eintragen, Kalender-Event erstellen, Erinnere mich an, Terminkalender.',
                'parameters' => [
                    'type' => 'object',
                    'properties' => [
                        'title' => [
            ...
            [
                ...
                'description' => 'Verändert einen bestehenden Termin (verschieben, umbenennen). Du FRAST erst die IDs mit get_calendar_events ab, bevor du dieses Tool nutzt! Stichworte: Termin verschieben, Kalender Eintrag ändern, Meeting verlegen, Termin Update.',
                'parameters' => [
                    'type' => 'object',
                    'properties' => [
                        'event_id' => [
            ...
            [
                ...
                'description' => 'Löscht einen Termin dauerhaft. Stichworte: Termin absagen, lösche das Meeting aus dem Kalender, Termin entfernen.',
                'parameters' => [
                    'type' => 'object',
                    'properties' => [
                        'event_id' => [
