...
class AiMethod extends Component
{
    ...
    {
        if (!class_exists(AiToolUsage::class)) return ['total' => [], 'chart' => []];

        // 1. Total usage per tool
        $totals = AiToolUsage::selectRaw('tool_name, COUNT(*) as count')
            ->groupBy('tool_name')
        ...
        $dailyUsages = AiToolUsage::where('used_at', '>=', $startDate)
    ...
    public function render()
    {
        ...
        return view('livewire.shop.ai.ai-method', [
            'methods' => $methods,
    ...
    {
        // Wir holen die rohen Schema-Daten
        ...
        $modules = [
            'Finanzen & Buchhaltung' => [
                ...
                'features' => [
                    ...
                    'Verträge ansehen' => class_exists(\App\Models\Finance\AccountingCostItem::class) && false,
                ]
            ],
            'Marketing & Kundenakquise' => [
                ...
                'features' => [
                    ...
                    'Newsletter verwalten' => class_exists(\App\Models\Marketing\MarketingNewsletter\NewsletterCampaign::class) && false,
            ...
            'Wissen & Gedächtnis' => [
                ...
                'features' => [
                    'Kurzzeitgedächtnis (Chat-History)' => true,
