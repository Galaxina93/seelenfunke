        ...
        try {
            ...
            GlobalLog::create([
                ...
                'details' => json_encode([
                    ...
                    'intent' => $this->currentPaymentIntentId ?? null,
                    'email' => $this->email ?? null
                ])
            ]);

            throw new \Exception("Beim Erstellen deiner Bestellung ist ein Fehler aufgetreten. Bitte versuche es erneut oder kontaktiere den Support.");
        }
    }
