...
class FunkiTicketSystemComponent extends Component
{
    ...
    public function sendReply()
    {
        ...
        $isOnline = false;
        $lastCustomerMsg = FunkiTicketMessage::where('funki_ticket_id', $ticket->id)
            ->where('sender_type', 'customer')
            ->latest('id')
            ->first();
    ...
    {
        $query = FunkiTicket::with('customer', 'messages', 'order')
        ...
        return view('backend.admin.livewire.funki-ticket-system-component', [
            'tickets' => $tickets,
