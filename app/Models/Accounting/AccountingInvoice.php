...
class AccountingInvoice extends Model
{
    ...
    {
        return $this->belongsTo(AccountingInvoice::class, 'parent_id');
    }
    ...
    {
        return $this->hasOne(AccountingInvoice::class, 'parent_id');
    }
    ...
    public function getItemsAttribute()
    {
        if ($this->order_id && $this->order) {
            ...
            return $this->order->items->map(function($item) use ($defaultTax) {
                return (object)[
