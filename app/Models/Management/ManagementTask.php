...
class ManagementTask extends Model
{
    ...
    {
        return $this->belongsTo(ManagementTaskList::class, 'task_list_id');
    }
    ...
    {
        return $this->belongsTo(ManagementTask::class, 'parent_id');
    }
    ...
    {
        return $this->hasMany(ManagementTask::class, 'parent_id')
